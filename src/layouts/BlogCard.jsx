...
const BlogCard = ({ img, headlines, description }) => {
  return (
    <div className=' w-full lg:w-2/6 p-4 shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] space-y-2 rounded-lg cursor-pointer hover:scale-105 transition duration-300 ease-in-out'>
      <img
