      ...
      <div className='bg-gray-50 lg:px-16 px-8 py-16'>
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8'>
          {product.productList.map((content) => (
            <div className='p-4 shadow-md bg-white rounded-md group hover:cursor-pointer'>
              <img
              ...
              <div className="flex justify-between items-end">
                <div className='flex flex-col w-3/4'>
                  <CardTitle className="group-hover:text-black" title={content.name.length > 15 ? content.name.slice(0, 15) + "..." : content.name} />
                  <CardParagraph className={"group-hover:text-black"} description={content.description.length > 60 ? content.description.slice(0, 60) + "..." : content.description} />
                </div>
