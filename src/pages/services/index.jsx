      ...
      <div className='flex gap-2 flex-col items-center lg:flex-row justify-between'>
        <div className='flex flex-col gap-3 md:w-2/3'>
          ...
          <p className='text-justify lg:text-start text-gray-700 max-md:text-xs'>
            We provide a comprehensive range of pharmaceutical solutions,
            including tablet and nutraceutical manufacturing, generic medicines,
            suppositories, injections, advanced molecules, and premixes.
          </p>
        </div>
